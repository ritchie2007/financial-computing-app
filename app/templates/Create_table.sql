...
CREATE TABLE [tbl_Task]([task_id] Integer PRIMARY KEY,[client_corp_id] INT,[client_corp_name] VARCHAR(150),[client_corp_bussi_no] VARCHAR(20),[client_indiv_id] INT,[client_indiv_name] VARCHAR(100),[client_indiv_sin] VARCHAR(10),[jobtype_id] INT,[jobtype_code] VARCHAR(20),[periodend] VARCHAR(20),[responsible] VARCHAR(100),[startdate] VARCHAR(20),[enddate] VARCHAR(20),[status] VARCHAR(10),[details] text(400),[recurrence] VARCHAR(10),[priority] VARCHAR(10),[worktime] DECIMAL(2),[renewperiod] VARCHAR(20),[renewstartdate] VARCHAR(20),[renewenddate] VARCHAR(20),[createdate] VARCHAR(20),[serialno] FLOAT)
...
CREATE TABLE [tbl_jobType]([job_id] integer PRIMARY KEY,[short_code] VARCHAR(20),[name] VARCHAR(100),[description] TEXT(500))
